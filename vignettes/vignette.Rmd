...
## Engines
`imagine` performs algorithms (called 'engines') written in C++ using **Rcpp** and **RcppArmadillo**, ensuring the faster application of filters. Since version 2.1.0, `imagine` includes the following engines:
